...
\begin{verse}
  ...
  The village lay beneath the heavy snow, \\
  And the palace hill was nowhere in sight. \\
  ...
  To offer to our hero something truly good.
\end{verse}
\begin{verse}
  \begin{center}
    \textbf{2} \\
...
\begin{verse}
  ...
  The young man was the son of someone known, \\
  And in affection for K., as cold as a stone.
\end{verse}
\newpage
\begin{verse}
  \begin{center}
    \textbf{4} \\
  \end{center}
  He was a big deal, the son of the Palace \\
...
\begin{verse}
  ...
  Traveled so far on this expedition \\
...
\begin{verse}
  \begin{center}
    \textbf{12} \\
  \end{center}
  ``But sadly on the road I lost my way \\
...
\begin{verse}
  \begin{center}
    \textbf{13} \\
  \end{center}
  "Tomorrow my assistants will arrive \\
...
\begin{verse}
  \begin{center}
    \textbf{19} \\
  \end{center}
  So Schwarzer then was suspicious of him! \\
...
\begin{verse}
  \begin{center}
    \textbf{22} \\
  \end{center}
  Soon did the phone’s bray cut through the quiet. \\
...
\begin{verse}
  \begin{center}
    \textbf{30} \\
  \end{center}
  K. polished off his meal and wished to go \\
...
\begin{verse}
  ...
  My skills personally to the \textit{Herren}." \\
...
\begin{verse}
  ...
  The presence of the \textit{Wirt} and the amount \\
...
\begin{verse}
  ...
  Slowly, "But we, we the \textit{bauren}, are free, \\
...
\begin{verse}
  ...
  What with their black pointed beards and their dark brown skins.
\end{verse}
\begin{verse}
  \begin{center}
    \textbf{71}
...
\begin{verse}
  ...
  \textit{Bauren} house, both staring at him with grim \\
